  ...
  return <section id="about" className="py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-gradient-card p-8 rounded-2xl border border-primary/10 hover:border-primary/30 transition-all duration-300">
          <p className="text-lg text-foreground/90 leading-relaxed mb-6">I'm a passionate game developer, dedicated to crafting engaging and innovative gaming experiences. My journey in game development has allowed me to work on diverse projects, from fast-paced action games to strategic roguelikes.</p>
